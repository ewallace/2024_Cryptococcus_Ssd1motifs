...
ggplot(data = CNYTCNYT_count_df, aes(x = count_mRNA)) +
    ...
    scale_x_continuous("CNYTCNYT counts per mRNA",
...
ggplot(data = CNYTCNYT_count_df, aes(x = count_5UTR)) +
    ...
    scale_y_continuous("Cumulative proportion\nof mRNAs",
                       limits = c(0,1),
                       expand = expansion(0, 0)) +
    scale_x_continuous("CNYTCNYT counts per 5'UTR",
                       limits = c(0,20), oob = scales::squish,
                       expand = expansion(0, 0)) +
  # geom_text(data = left_join(genes_of_interest,
  #                             CNYTCNYT_count_df),
...
Figure: Numbers of predicted Ssd1-binding motifs on Cryptococcos messenger RNAs, shown as cumulative distribution.
